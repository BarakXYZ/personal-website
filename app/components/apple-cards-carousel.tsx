          ...
          >
            {items.map((item, index) => (
              <motion.div
                ...
                key={"card" + index}
                // Padding from the right (when reaching the end)
                className="last:pr-4 md:last:pr-4 rounded-3xl"
              >
                {item}
              </motion.div>
            ))}
        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto flex items-center justify-center">
            ...
            <motion.div
              ...
              className="max-w-5xl mx-auto bg-white dark:bg-neutral-900 h-fit z-[60] p-4 md:p-10 rounded-3xl font-sans relative max-h-[90vh] overflow-y-auto"

              // Full Screen Modal
              // className="w-full max-w-[95vw] md:max-w-[90vw] bg-white dark:bg-neutral-900 h-[95vh] z-[60] p-4 md:p-10 rounded-3xl font-sans relative overflow-y-auto flex flex-col items-center"
            >
              <button
